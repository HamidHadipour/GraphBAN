...
df_train = pd.read_csv("run_bindingdb/inductive/seed12/source_train_bindingdb12.csv")
df_val = pd.read_csv("run_bindingdb/inductive/seed12/target_train_bindingdb12.csv")
df_test = pd.read_csv("run_bindingdb/inductive/seed12/target_test_bindingdb12.csv")

#df_train = pd.read_csv("run_biosnap/inductive/seed20/source_train_biosnap20.csv")
#df_val = pd.read_csv("run_biosnap/inductive/seed20/target_train_biosnap20.csv")
#df_test = pd.read_csv("run_biosnap/inductive/seed20/target_test_biosnap20.csv")
...
train_emb = pd.read_parquet("run_bindingdb/inductive/seed12/bindingdb12_inductive_teacher_emb.parquet")
