...
command_template = (
    "python predict.py --test_path zinc_data/split_zinc_{index}.csv "
    "--folder_path result_kiba12_zinc{index} --save_dir test_zinc{index}_preds.csv"
...
for i in range(1,26):
    ...
    folder_name = f"result_kiba12_zinc{i}"
