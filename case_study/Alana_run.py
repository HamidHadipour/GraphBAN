...
command_template = (
    "python run_model.py --train_path bindingdb_train_data/source_train_bindingdb12.csv "
    "--val_path zinc_data2/split_zinc_{index}.csv --test_path zinc_data2/split_zinc_{index}.csv "
    "--seed {index} --mode inductive --teacher_path bindingdb_train_data/bindingdb12_inductive_teacher_emb.parquet "
    "--result_path result_bindingdb12_zinc2{index}/"
)
