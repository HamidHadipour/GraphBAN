...
parser.add_argument("--result_path", type=str, required=True, help="Path to the result folder.")
...
if args.mode == 'inductive':
    cfg_path = "case_study/GraphBAN_DA.yaml"
else:
    cfg_path = "case_study/GraphBAN.yaml"
...
if not cfg.DA.USE:
    ...
    trainer = Trainer(modelG, opt, device, multi_generator, val_generator, test_generator,pp, opt_da=opt_da,
