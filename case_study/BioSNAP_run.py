...
command_template = (
    "python case_study/run_model.py --train_path case_study/biosnap_train_data/source_train_biosnap12.csv "
    "--val_path case_study/zinc_data/split_zinc_{index}.csv --test_path case_study/zinc_data/split_zinc_{index}.csv "
    "--seed {index} --mode inductive --teacher_path case_study/biosnap_train_data/biosnap12_inductive_teacher_emb.parquet "
    "--result_path case_study/result_biosnap12_zinc2{index}/"
)
