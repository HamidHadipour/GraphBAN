...
command_template = (
    "python run_model.py --train_path biosnap_train_data/source_train_biosnap12.csv "
    "--val_path zinc_data2/split_zinc_{index}.csv --test_path zinc_data2/split_zinc_{index}.csv "
    "--seed {index} --mode inductive --teacher_path biosnap_train_data/biosnap12_inductive_teacher_emb.parquet "
    "--result_path result_biosnap12_zinc2{index}/"
)
